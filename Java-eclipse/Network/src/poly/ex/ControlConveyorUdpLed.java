...
import java.net.*;
import java.util.*;
public class ControlConveyorUdpLed {
	// PLC IPアドレス
	...
	private static final String PLC_CONV_COMMAND_HEAD = "02FF00025920000000100600";
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			System.out.println("使用法： P1ランプ点灯 1000｜P2ランプ点灯 0100｜P3ランプ点灯 0010｜P4ランプ点灯 0001|全灯 1111|消灯 0000");
